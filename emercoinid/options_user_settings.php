...
if(
	$ID > 0
	&& \Bitrix\Main\Loader::includeModule('emercoinid')
	&& \Bitrix\Main\Config\Option::get("emercoinid", "bitrix24net_id", "") != ""
):
...
?>
	<input type="hidden" name="profile_module_id[]" value="emercoinid">
<?
	if(!$profileInfo)
	{
?>
...
<?
		if($ID == $USER->GetID()):
			$url = \Bitrix\Emercoinid\Network::getAuthUrl("popup", array("admin"));
?>
