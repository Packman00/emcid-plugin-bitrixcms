<?php
require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/emercoinid/classes/general/authmanager.php");
	...
	extends CEmcAuth
{
	public static function Add($arFields)
	{
		...
		$arInsert = $DB->PrepareInsert("b_emercoinid_user", $arFields);
		$strSql =
			"INSERT INTO b_emercoinid_user (".$arInsert[0].") ".
				"VALUES(".$arInsert[1].")";
		...
		$arFields['ID'] = $lastId;
		foreach(GetModuleEvents("emercoinid", "OnAfterEmcUserAdd", true) as $arEvent)
...
class CEmcMessage extends CEmcAllMessage
{
	function CleanUp()
	{
		global $DB;

		$strSql = "DELETE FROM b_emercoinid_message WHERE INSERT_DATE < DATE_ADD(now(), INTERVAL -4 DAY)";
		$DB->Query($strSql, false, "File: ".__FILE__."<br>Line: ".__LINE__);

		return "CEmcMessage::CleanUp();";
	}
	...
	static function Add($arFields)
	{
		...
		$arInsert = $DB->PrepareInsert("b_emercoinid_message", $arFields);
		$strSql =
			"INSERT INTO b_emercoinid_message (".$arInsert[0].") ".
				"VALUES(".$arInsert[1].")";
