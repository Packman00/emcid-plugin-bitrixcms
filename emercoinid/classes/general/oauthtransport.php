...
class CEmcOAuthTransport
{
	...
	public function __construct($authUrl, $authToken, $accountUrl, $appID, $appSecret, $code = false)
	{
		global $USER;
	...
	public function deleteStorageTokens()
	{
		if($this->userId > 0)
		{
			$dbSocservUser = \Bitrix\Emercoinid\UserTable::getList(array(
				'filter' => array(
					'=USER_ID' => $this->userId,
					"=EXTERNAL_AUTH_ID" => static::SERVICE_ID
				),
			...
			{
				\Bitrix\Emercoinid\UserTable::delete($accessToken['ID']);
			}
		}
	}
