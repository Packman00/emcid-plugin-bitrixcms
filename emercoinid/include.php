...
$arClasses = array(
	"CEmcAuthManager" => "classes/general/authmanager.php",
	"CEmcAuthDB" => "classes/".$DBType."/authmanager.php",
	"CEmcUtil" => "classes/general/authmanager.php",
	"CEmcAuth" => "classes/general/authmanager.php",
	"CEmcOAuthTransport" => "classes/general/oauthtransport.php",
	"CEmcMessage" => "classes/".$DBType."/authmanager.php",
	"CEmcEmercoinIDAuth" => "classes/general/emercoinid.php",
...
CModule::AddAutoloadClasses("emercoinid", $arClasses);

$arJSDescription = array(
	'js' => '/bitrix/js/emercoinid/ss_timeman.js',
	'css' => '/bitrix/js/emercoinid/css/ss.css',
	'rel' => array('popup', 'ajax', 'fx', 'ls', 'date', 'json'),
	'lang' => '/bitrix/modules/emercoinid/lang/'.LANGUAGE_ID.'/js_emercoinid.php'
	);

if(IsModuleInstalled("timeman"))
{
	$userEmcEnable = CEmcAuthManager::GetCachedUserOption("user_socserv_enable");
	if($userEmcEnable != '')
		$arJSDescription['lang_additional'] = array('IS_ENABLED' => $userEmcEnable);
}

CJSCore::RegisterExt('socserv_timeman', $arJSDescription);

class CEmcEventHandlers
{
