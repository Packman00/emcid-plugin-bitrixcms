CREATE TABLE IF NOT EXISTS b_emercoinid_user
(
...
CREATE TABLE IF NOT EXISTS  b_emercoinid_message
(
	ID INT NOT NULL AUTO_INCREMENT,
	USER_ID INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS b_emercoinid_user_link
(
	ID INT NOT NULL AUTO_INCREMENT,
	USER_ID INT NOT NULL,
	SOCSERV_USER_ID INT NOT NULL,
	...
	PRIMARY KEY(ID),
	INDEX ix_b_emercoinid_user_link_5 (SOCSERV_USER_ID),
	INDEX ix_b_emercoinid_user_link_6 (LINK_USER_ID, TIMESTAMP_X),
	INDEX ix_b_emercoinid_user_link_7 (LINK_UID)
);

CREATE TABLE IF NOT EXISTS b_emercoinid_contact
(
	ID INT NOT NULL AUTO_INCREMENT,
	...
	PRIMARY KEY (ID),
	INDEX ix_b_emercoinid_contact1(USER_ID),
	INDEX ix_b_emercoinid_contact2(CONTACT_USER_ID),
	INDEX ix_b_emercoinid_contact3(TIMESTAMP_X),
	INDEX ix_b_emercoinid_contact4(LAST_AUTHORIZE)
);

CREATE TABLE IF NOT EXISTS b_emercoinid_contact_connect
(
	ID INT NOT NULL AUTO_INCREMENT,
	TIMESTAMP_X TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
	CONTACT_ID INT NULL,
	...
	LAST_AUTHORIZE datetime,
	PRIMARY KEY (ID),
	INDEX ix_b_emercoinid_contact_connect1(CONTACT_ID),
	INDEX ix_b_emercoinid_contact_connect2(LINK_ID),
	INDEX ix_b_emercoinid_contact_connect3(LAST_AUTHORIZE)
);
